 ...
 * @fileoverview Page set PageGhotiPrintSub
 */
...
class PageGhotiPrintSub extends React.Component<IProps, IState> {
    state = {
        //page:null,
        Address: '',
        Area: '',
                    ...
                    <tbody>{this.state.Item.map(function (item, key) {
                        return (
                            <React.Fragment key={key}>
                                ...
                                ></td> */}
                                <tr><th style={{textAlign:"center"}} colSpan={6}>Before </th></tr>
                                <tr><td colSpan={6}>{this.mapPicture(item.Before, item.description, item.Comments)}</td></tr>
                                <tr><th style={{textAlign:"center"}}colSpan={6}> During </th></tr>
                                <tr><td colSpan={6}>{this.mapPicture(item.During, item.description, item.Comments)}</td></tr>
                                <tr><th style={{textAlign:"center"}}colSpan={6}> After </th></tr>
                                <tr><td colSpan={6}>{this.mapPicture(item.After, item.description, item.Comments)}</td></tr>

                            </React.Fragment>
                        )
                    }.bind(this))}
                        <tr><td colSpan={6}>Total Amount: ${SubTotal} </td></tr>
                    </tbody>
                    {/* <tbody>
...
export default PageGhotiPrintSub;
